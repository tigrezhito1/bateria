# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2018-07-17 14:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telef_1', models.CharField(blank=True, max_length=1000, null=True)),
                ('cliente', models.CharField(blank=True, max_length=1000, null=True)),
                ('telef_2', models.CharField(blank=True, max_length=1000, null=True)),
                ('direccion', models.CharField(blank=True, max_length=1000, null=True)),
                ('fechaAten', models.CharField(blank=True, max_length=1000, null=True)),
                ('hora_inst', models.CharField(blank=True, max_length=1000, null=True)),
                ('vehiculo', models.CharField(blank=True, max_length=1000, null=True)),
                ('modelo', models.CharField(blank=True, max_length=1000, null=True)),
                ...
                ('kms', models.CharField(blank=True, max_length=1000, null=True)),
                ('placa', models.CharField(blank=True, max_length=1000, null=True)),
                ('cantidad', models.CharField(blank=True, max_length=1000, null=True)),
                ('marca', models.CharField(blank=True, max_length=1000, null=True)),
                ('modelo_bat', models.CharField(blank=True, max_length=1000, null=True)),
                ('precio', models.CharField(blank=True, max_length=1000, null=True)),
                ('cant_bat_usadas', models.CharField(blank=True, max_length=1000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('marca_v', models.CharField(blank=True, max_length=1000, null=True)),
                ('modelo_v', models.CharField(blank=True, max_length=1000, null=True)),
                ('serie', models.CharField(blank=True, max_length=1000, null=True)),
                ('anio', models.CharField(blank=True, max_length=1000, null=True)),
                ('motor', models.CharField(blank=True, max_length=1000, null=True)),
                ('color', models.CharField(blank=True, max_length=1000, null=True)),
